...
public class CollegeTest {
    ...
    public void whenAccountIsOptionalEmpty() {
        ...
        assertThat(college.findByAccount2("000010"), is(Optional.empty()));
    }
    ...
    public void whenAccountIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college.findByAccount2("000001").get().getGroup(), is("201-18-15"));
    }
    ...
    public void whenSubjectIsOptionalEmptyWithNotFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectName2("000010", "Sociology"), is(Optional.empty()));
    }
    ...
    public void whenSubjectIsOptionalEmptyWithFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectName2("000001", "Sociology"), is(Optional.empty()));
    }
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectName2("000002", "Sociology").get().getScore(), is(65));
    }
}